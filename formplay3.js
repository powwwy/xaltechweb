function validateForm() {
    ...
    var today = new Date();
    var minDate = new Date(today.getTime() + 21 * 24 * 60 * 60 * 1000); 
    ...
    if (selectedDate < minDate) {
        deadlineError.innerHTML = "Please allow at least 3 weeks for us to complete the order.";
        return false;
    }
...
function toggleAdditionalDomain() {
    var designType = document.getElementById("model_type").value;
